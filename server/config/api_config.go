...
var APIs = map[string]string{
	...
	"POST /posts/react":    "React to a post. Parameters: postID (integer), reaction (string).",
	"POST /comment/create": "Create a new comment on a post. Parameters: postID (integer), content (string), authorID (integer).",
	"POST /comment/react":  "React to a comment. Parameters: commentID (integer), reaction (string).",
