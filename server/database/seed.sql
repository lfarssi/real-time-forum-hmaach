...
INSERT INTO comments (post_id, user_id, hidden, content) VALUES
(1, 9, 0, 'I’m so excited to see initiatives like Zone 01 Oujda growing in Morocco. Tech skills are the future!'),
(1, 6, 0, 'Zone 01 Oujda is exactly what Morocco needs to develop its digital economy. Can’t wait to see more success stories!'),
(1, 7, 0, 'It’s amazing how Zone 01 Oujda is empowering young people with valuable skills that will open so many doors!'),
(1, 8, 0, 'I love that they provide 24/7 access to the campus. It shows they really care about the students'' success!'),
(1, 10, 0, 'Zone 01 Oujda is setting the standard for tech education in Morocco. This is just the beginning!'),
(1, 11, 0, 'Such an incredible initiative for young Moroccans who want to make a mark in the tech world.'),
(1, 12, 0, 'Can anyone share their experience at Zone 01 Oujda? I’m considering applying!'),
(1, 13, 0, 'I really appreciate how they make coding accessible to everyone, no matter their background.'),
(1, 14, 0, 'Great to see the Moroccan government supporting programs like Zone 01 Oujda to empower youth and grow the tech ecosystem.'),
(1, 15, 0, 'It’s fantastic to see an education program that not only teaches coding but also helps students transition into real jobs!'),
(1, 16, 0, 'This is the future of education, hands-on and practical, with a clear path to employment.'),
(1, 17, 0, 'I’m inspired by the success stories coming out of Zone 01 Oujda. It’s changing lives!'),
(1, 18, 0, 'Zone 01 Oujda for giving young people the chance to succeed in the digital economy.'),
(1, 19, 0, 'It’s inspiring to see tech education become more accessible in Morocco. Keep up the great work, Zone 01 Oujda!'),
(1, 20, 0, 'Zone 01 Oujda is definitely a game-changer for the future of technology education in Morocco. Can’t wait to see it grow!'),
(2, 9, 0, 'I wish RS Berkane win the Botola Pro, they deserve it'),
(2, 6, 0, 'Berkane really is underrated. Great people and views!'),
(2, 7, 0, 'Just visited last summer. The beaches in saidia are so peaceful!'),
(2, 8, 0, 'Been living here for 2 years, and I’ve never wanted to leave!'),
(2, 12, 0, 'Anyone know the best places for hiking around Berkane?'),
(2, 13, 0, 'I fell in love with Berkane the moment I stepped foot here.'),
(2, 15, 0, 'Is it safe to walk around the city late at night?'),
(2, 16, 0, 'Berkane’s markets are so vibrant. Great for souvenirs!'),
(2, 18, 0, 'Anyone knows where I can get the best traditional clothes here?'),
(2, 19, 0, 'The local people are so friendly and welcoming. Love this city!'),
(6, 2, 0, 'Match of the year! Raja played beautifully'),
(7, 2, 0, 'Referee decisions kant questionable'),
(8, 2, 0, 'Atmosphere f l3arena kant incredible'),
(9, 2, 0, 'Next derby ghadi tkoun more exciting'),
(10, 3, 0, 'Interested f collaboration! DM me details'),
(11, 3, 0, 'Startup scene really improving f Casa'),
(12, 3, 0, 'We need more investors though'),
(13, 3, 0, 'Can you share more about digital marketing opportunities?'),
(14, 4, 0, 'Great healthy ideas! Ana zdt smoothies for energy'),
(15, 5, 0, 'Finally! Transportation f Casa needs this'),
(16, 6, 0, 'MacBook definitely worth it for developers'),
(17, 7, 0, 'WAC deserves the lead this season'),
(18, 8, 0, 'Very inspiring! Keep up the good work'),
(19, 9, 0, 'Important topic, thank you for bringing awareness'),
(20, 10, 0, 'Cultural events are exactly what we need'),
(1, 11, 0, 'AI is the future, glad Morocco is investing'),
(2, 12, 0, 'So proud of our women''s team!'),
(3, 13, 0, 'Great news for the startup ecosystem'),
(4, 14, 0, 'Health guidelines are very clear, thanks'),
(5, 15, 0, 'Will definitely attend the conference'),
(6, 16, 0, 'Great initiative for young athletes'),
(7, 17, 0, 'Online shopping really improved this year'),
(8, 18, 0, 'Joined the challenge! Let''s do this'),
(9, 19, 0, 'Economy looking strong for 2024'),
(10, 20, 0, 'Smart cities initiative is impressive');
